...
def MAIN_EXTRACT(args):
    ...
    ops.copyto(ops.path_join(src_usr_lib_dir, "libtasn1.so.6.5.3"), dst_usr_lib_dir)
    ops.ln(dst_usr_lib_dir, "libtasn1.so.6.5.3", "libtasn1.so.6.5")
    ops.ln(dst_usr_lib_dir, "libtasn1.so.6.5.3", "libtasn1.so.6")
    ops.ln(dst_usr_lib_dir, "libtasn1.so.6.5.3", "libtasn1.so")
    return True
...
def MAIN_INSTALL(args):
    ...
    iopc.installBin(args["pkg_name"], ops.path_join(src_include_dir, "libtasn1.h"), dst_include_dir)
